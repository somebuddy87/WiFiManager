...
const char HTTP_HEAD_START[]       PROGMEM = "<!DOCTYPE html><html lang='en'><head><meta name='format-detection' content='telephone=no'><meta charset='UTF-8'><meta  name='viewport' content='width=device-width,initial-scale=1,user-scalable=no'/><title>LOXpixel! Setup Test</title>";
...
const char HTTP_ROOT_MAIN[]        PROGMEM = "<h1>LOXpixel! V1.0</h1><a href='https://unser-smartes-zuhause.de'>https://unser-smartes-zuhause.de</a><h3>Setup</h3>";
...
const char S_titlewifi[]          PROGMEM = "Config LOXpixel!";
...
const char S_resetting[]          PROGMEM = "LOXpixel! will reset in a few seconds.";
